...
class pdfController extends Controller
{
    ...
    public function aiepi()
    {
        ...
        $pdf->Image(ROOT.'views'.DS.'layout'.DS.'default'.DS.'img'.DS.'logo_gobernacion.jpg',10,5,30);
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(54);
        // Título
        $pdf->Cell(1,5,utf8_decode('DEPARTAMENTO DE CUNDINAMARCA - SECRETARIA DE SALUD - DIRECCIÓN SALUD PUBLICA'),'C');
        // Salto de línea
        $pdf->Ln(5);
        $pdf->Cell(80);
        $pdf->Cell(3,5,utf8_decode('ATENCION INFANTIL - NIÑOS Y NIÑAS MENORES DE 5 AÑOS - AIEPI'),'C');
